...
export default function AdminLayout() {
 ...
 <div className="lg:pl-60"><header className="flex h-16 items-center justify-between border-b border-outline px-5 lg:justify-end"><button className="lg:hidden" onClick={()=>setOpen(true)} aria-label="Open navigation" aria-expanded={open}><Menu/></button><ThemeToggle/></header><main className="p-5 lg:p-7"><div className="mb-5 rounded-lg bg-background px-3 py-2 text-xs text-muted">Demo workspace - Changes last until this page is refreshed. Backend authentication is not connected.</div><Outlet/></main></div>
 </div>
}
